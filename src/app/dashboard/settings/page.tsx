  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-400">Manage your WhatsApp API and AI Model credentials securely.</p>
      </div>
      ...
      <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            <div className="group">
              ...
              <input 
                ...
                placeholder="e.g. 22279|1Khrs6pJRdeatneNI2PVvZqjL8FjZwyqcyMUroyzb..."
                className="w-full bg-gray-950/50 border border-gray-700 rounded-xl px-5 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all"
              />
            </div>
            
            <div className="group">
              <label className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-indigo-400 transition-colors">Phone Number ID</label>
              <input 
                type="text" 
                name="wm_phone_number_id"
                value={config.wm_phone_number_id}
                onChange={handleChange}
                placeholder="e.g. 938657545999837"
                className="w-full bg-gray-950/50 border border-gray-700 rounded-xl px-5 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all"
              />
            </div>
          </div>
          ...
          <div className="space-y-5 pt-2">
            ...
            <div className="group">
              <label className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-indigo-400 transition-colors">Gemini API Key</label>
              <input 
                type="password" 
                name="gemini_api_key"
